...
public class ListarMeseros extends javax.swing.JFrame {
    ...
    MeseroData meData= new MeseroData ();
...
//        para que sus celdas no sean editables
    ...
    private void initComponents() {
        ...
        jlVentaPorHora.setText("Listar Meseros");

        jTMesero.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
...
public void cargarTabla(){
    ...
    meseros= meData.listarMeseros();
    
    for (Mesero mesero1 : meseros) {
         modelo.addRow(new Object[]{mesero1.getIdMesero(), mesero1.getNombreMesero(), mesero1.getApellidoMesero()});
