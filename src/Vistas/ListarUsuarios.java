...
public void cargarTabla(){
    ...
    usuarios= uData.listarUsuarios();
    
    for (Usuario usuario1 : usuarios) {
         modelo.addRow(new Object[]{usuario1.getUsername(), usuario1.getContrasena(), usuario1.getNivel(), usuario1.getNombre(),usuario1.getApellido()});
