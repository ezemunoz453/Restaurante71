...
public class ListarMesas extends javax.swing.JFrame {
...
//        para que sus celdas no sean editables
    ...
    private void initComponents() {
        ...
        jlVentaPorHora.setText("Listar Mesas");
...
public void cargarTabla(){
    ...
    for (Mesa mesa1 : mesas) {
         modelo.addRow(new Object[]{mesa1.getNumeroMesa(), mesa1.getCapacidad(), mesa1.getEstado()});
